...
<svelte:head>
  <title>Terms and conditions: GRE SE</title>
</svelte:head>

<div class="my-10">
  <Heading>Terms and Conditions</Heading>

  <P class="mt-6">Welcome to GRE SE!</P>

  <P class="mt-6"
    >These terms and conditions outline the rules and regulations for the use of
    GRE SE's Website, located at https://gre-sentence-equivalence.com/.</P
  >

  <P class="mt-6"
    >By accessing this website we assume you accept these terms and conditions.
    Do not continue to use GRE SE if you do not agree to take all of the terms
  ...
  <P class="mt-6"
    ...
    of jp. Any use of the above terminology or other words in the singular,
    plural, capitalization and/or he/she or they, are taken as interchangeable
    and therefore as referring to same.</P
  >

  <Heading tag="h2" class="mt-4">Memberships</Heading>
  <P class="mt-6">
    <Span class="uppercase">Billing</Span> : Fees for the GRE SE Pro Lifetime Membership
    are charged once, and membership begins upon successful payment. Subscription
    fees for the GRE SE Pro Yearly Membership are not recurring payments. Your subscription
    begins upon payment of subscription fees. You lose access to the contents after
    your subscription expires. In that case you can choose to resubscribe again.
    <br />

    <Span class="uppercase">Refunds</Span> : We don't offer refunds. We offer free
    practice content and a few free lessons from each course for you to try out the
    content. If you believe there was a mistake please reach out to GRE SE support
    at <A rel="external" href="mailto:support@gre-sentence-equivalence.com">support@gre-sentence-equivalence.com</A>.
    <br />

    <Span class="uppercase">Sign-up</Span>: By signing up for GRE SE, you grant
    GRE SE permission to send email communications to the email address
    associated with your account provider. If you receive promotional emails
    from GRE SE, you can unsubscribe by clicking the bottom Unsubscribe or
    Opt-Out link at the bottom of every email.
    <br />
    <Span class="uppercase">Cancellations</Span>: You can not cancel your GRE SE
    membership once purchased. The auto cancellation will take effect at the end
    of the current billing period.
  </P>

  <Heading tag="h2" class="mt-4">Cookies</Heading>

  <P class="mt-6"
    >We employ the use of cookies. By accessing GRE SE, you agreed to use
    cookies in agreement with the GRE SE's Privacy Policy.
  </P>
  ...
  <Heading tag="h2" class="mt-4">License</Heading>

  <P class="mt-6"
    >Unless otherwise stated, GRE SE and/or its licensors own the intellectual
    property rights for all material on GRE SE. All intellectual property rights
    are reserved. You may access this from GRE SE for your own personal use
    subjected to restrictions set in these terms and conditions.</P
  >

  <P class="mt-6">You must not:</P>
  <ul class="list-disc">
    <li>Republish material from GRE SE</li>
    <li>Sell, rent or sub-license material from GRE SE</li>
    <li>Reproduce, duplicate or copy material from GRE SE</li>
    <li>Redistribute content from GRE SE</li>
  </ul>

  <P class="mt-6"
    >Parts of this website offer an opportunity for users to post and exchange
    opinions and information in certain areas of the website. GRE SE does not
    filter, edit, publish or review Comments prior to their presence on the
    website. Comments do not reflect the views and opinions of GRE SE,its agents
    ...
    GRE SE shall not be liable for the Comments or for any liability, damages or
  ...
  <P class="mt-6"
    >GRE SE reserves the right to monitor all Comments and to remove any
    Comments which can be considered inappropriate, offensive or causes breach
    of these Terms and Conditions.</P
  >

  <P class="mt-6">You warrant and represent that:</P>
  ...
  <P class="mt-6"
    >You hereby grant GRE SE a non-exclusive license to use, reproduce, edit and
  ...
  <P class="mt-6"
    ...
    compensates the absence of GRE SE; and (d) the link is in the context of
  ...
  <P class="mt-6"
    ...
    e-mail to GRE SE. Please include your name, your organization name, contact
  ...
  <P class="mt-6"
    >No use of GRE SE's logo or other artwork will be allowed for linking absent
    a trademark license agreement.</P
  >

  <Heading tag="h2" class="mt-4">iFrames</Heading>
  ...
  <Heading tag="h2" class="mt-4">Content Liability</Heading>
  ...
  <Heading tag="h2" class="mt-4">Reservation of Rights</Heading
  >
  ...
  <Heading tag="h2" class="mt-4">Disclaimer</Heading>

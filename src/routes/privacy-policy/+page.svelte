...
<div class="my-10 text-justify">
  ...
  <P class="mt-6">
    At GRE SE, accessible from https://gre-sentence-equivalence.com/, one of our
    main priorities is the privacy of our visitors. This Privacy Policy document
    contains types of information that is collected and recorded by GRE SE and
    how we use it.
  </P>
  ...
  <P class="mt-6">
    ...
    and/or collect in GRE SE. This policy is not applicable to any information
    collected offline or via channels other than this website.
  </P>

  <Heading tag="h2" class="mt-4">Consent</Heading>
  ...
  <Heading tag="h2" class="mt-4">Information we collect</Heading>
  ...
  <Heading tag="h2" class="mt-4">How we use your information</Heading>
  ...
  <Heading tag="h2" class="mt-4">Log Files</Heading>

  <P class="mt-6">
    GRE SE follows a standard procedure of using log files. These files log
  ...
  <Heading tag="h2" class="mt-4">Cookies and Web Beacons</Heading>

  <P class="mt-6">
    Like any other website, GRE SE uses "cookies". These cookies are used to
  ...
  <Heading tag="h2" class="mt-4">Advertising Partners Privacy Policies</Heading>

  <P class="mt-6">
    You may consult this list to find the Privacy Policy for each of the
    advertising partners of GRE SE.
  </P>

  <P class="mt-6">
    Third-party ad servers or ad networks uses technologies like cookies,
    JavaScript, or Web Beacons that are used in their respective advertisements
    and links that appear on GRE SE, which are sent directly to users' browser.
  ...
  <P class="mt-6">
    Note that GRE SE has no access to or control over these cookies that are
    used by third-party advertisers.
  </P>

  <Heading tag="h2" class="mt-4">Third Party Privacy Policies</Heading>

  <P class="mt-6">
    GRE SE's Privacy Policy does not apply to other advertisers or websites.
  ...
  <Heading tag="h2" class="mt-4"
    >CCPA Privacy Rights (Do Not Sell My Personal Information)</Heading
  >
  ...
  <Heading tag="h2" class="mt-4">GDPR Data Protection Rights</Heading>
  ...
  <Heading tag="h2" class="mt-4">Children's Information</Heading>
  ...
  <P class="mt-6">
    GRE SE does not knowingly collect any Personal Identifiable Information from
  ...
  <Heading tag="h2" class="mt-4">Changes to This Privacy Policy</Heading>
  ...
  <Heading tag="h2" class="mt-4">Contact Us</Heading>
